...
export function getAclUserList(params: AclUser.ReqAclUserListParams) {
  return http.get<PageRes<AclUser.ResAclUserList>>(`/admin/acl/user/${params.pageNum}/${params.pageSize}`, {
...
export function getUserRolesList(userId: string) {
  return http.get<PageRes<AclUser.ResUserRolesList>>(`/admin/acl/user/toAssign/${userId}`);
}
