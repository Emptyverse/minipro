...
export function getRolePermission(roleId: string | number) {
  return http.get<PageRes<Permission.ResPermisionList[]>>(`/admin/acl/permission/toAssign/${roleId}`);
}
...
export function assignRolePermission(data: Permission.ReqAssignPermision) {
  return http.post<PageRes<any>>(`/admin/acl/permission/doAssign`, {}, { params: data });
}
...
export function getPermissionList() {
  return http.get<PageRes<Permission.ResPermisionList[]>>(`admin/acl/permission`);
}
